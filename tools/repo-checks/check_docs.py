...
REQUIRED_FILES = [
    ...
    "docs/review/phase-17a-review.md",
    ...
    "apps/api/src/serviceops_api/owner_dashboard/__init__.py",
    "apps/api/src/serviceops_api/owner_dashboard/api.py",
    "apps/api/src/serviceops_api/owner_dashboard/models.py",
    "apps/api/src/serviceops_api/owner_dashboard/sla.py",
    "apps/api/src/serviceops_api/owner_dashboard/use_cases.py",
...
PHASE_SLICE_MAPS = [
    ...
    "17-public-demo-and-launch-closure.md",
    "17a-demo-performance-and-hero-image-optimization.md",
    "18-portfolio-packaging-and-demo-mode.md",
    "19-frontend-workspace-decomposition.md",
    "20-owner-dashboard-and-sla-foundation.md",
    "21-operational-n8n-automation.md",
    "22-procurement-lite.md",
    "23-technician-profiles-and-recommendation.md",
    "24-ai-assistant-with-tools.md",
]
