...
- `phases/01-foundation-runtime.md`
...
Detailed implementation plans are created just in time in `detailed/`. Completed detailed plan: `detailed/00-repository-harness-implementation.md`.
