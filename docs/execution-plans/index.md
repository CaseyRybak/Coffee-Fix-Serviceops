...
- Phase 19: `phases/19-frontend-workspace-decomposition.md`.
...
Current detailed plan: none. Create a Phase 19 detailed implementation plan before changing frontend workspace structure.
