...
- `phases/02-service-request-intake.md`
...
Detailed implementation plans are created just in time in `detailed/`. Completed detailed plans: `detailed/00-repository-harness-implementation.md`, `detailed/01-foundation-runtime-implementation.md`.
